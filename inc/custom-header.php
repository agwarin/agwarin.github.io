...
if ( ! function_exists( 'altitude_header_style' ) ) :
	...
	function altitude_header_style() {
		...
		$home_header_image = get_theme_mod( 'altitude_home_header_image', get_template_directory_uri() . '/images/home_header_image.jpg' );
		...
		if ( in_array('home',$classes) ) : ?>
			...
			<style type="text/css">
				#masthead-inner {
					background-image: url( <?php echo $home_header_image ?> );
				}
				#masthead:before {
					padding-top: 50%;
				}
