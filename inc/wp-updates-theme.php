...
new WPUpdatesThemeUpdater_882( 'http://wp-updates.com/api/2/theme', basename(get_template_directory()) );
*/

if( !class_exists('WPUpdatesThemeUpdater_882') ) {
    class WPUpdatesThemeUpdater_882 {
